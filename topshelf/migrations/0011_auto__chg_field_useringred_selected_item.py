...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'UserIngred.selected_item'
        db.alter_column(u'topshelf_useringred', 'selected_item', self.gf('django.db.models.fields.SmallIntegerField')())

    def backwards(self, orm):

        # Changing field 'UserIngred.selected_item'
        db.alter_column(u'topshelf_useringred', 'selected_item', self.gf('django.db.models.fields.BooleanField')())
    ...
    models = {
        ...
        u'topshelf.useringred': {
            ...
            'selected_item': ('django.db.models.fields.SmallIntegerField', [], {'default': '0'}),
