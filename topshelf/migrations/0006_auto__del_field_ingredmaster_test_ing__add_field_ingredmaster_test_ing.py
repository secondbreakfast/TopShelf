...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'IngredMaster_test.ing'
        db.delete_column(u'topshelf_ingredmaster_test', 'ing')

        # Adding field 'IngredMaster_test.ing_test'
        db.add_column(u'topshelf_ingredmaster_test', 'ing_test',
                      self.gf('django.db.models.fields.CharField')(default='apple', max_length=100),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'IngredMaster_test.ing'
        db.add_column(u'topshelf_ingredmaster_test', 'ing',
                      self.gf('django.db.models.fields.CharField')(default='apple', max_length=100),
                      keep_default=False)

        # Deleting field 'IngredMaster_test.ing_test'
        db.delete_column(u'topshelf_ingredmaster_test', 'ing_test')
