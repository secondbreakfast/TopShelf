...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'IngredMaster_test.ing_test'
        db.alter_column(u'topshelf_ingredmaster_test', 'ing_test', self.gf('django.db.models.fields.CharField')(max_length=100))

    def backwards(self, orm):

        # Changing field 'IngredMaster_test.ing_test'
        db.alter_column(u'topshelf_ingredmaster_test', 'ing_test', self.gf('django.db.models.fields.CharField')(max_length=10000))
