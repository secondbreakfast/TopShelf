...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'topshelf_ingredmaster_test', 'ing_test', self.gf('django.db.models.fields.CharField')(max_length=1000))
    ...
    models = {
        ...
        u'topshelf.ingredmaster_test': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'ing_test': ('django.db.models.fields.CharField', [], {'max_length': '1000'})
        },
