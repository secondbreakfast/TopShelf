...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        # Changing field 'IngredMaster_test.ing'
        db.alter_column(u'topshelf_ingredmaster_test', 'ing', self.gf('django.db.models.fields.CharField')(max_length=100))
    ...
    models = {
        ...
        u'topshelf.ingredmaster_test': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'ing': ('django.db.models.fields.CharField', [], {'max_length': '10000'})
        },
