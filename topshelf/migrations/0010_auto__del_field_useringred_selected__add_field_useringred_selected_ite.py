...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'UserIngred.selected'
        db.delete_column(u'topshelf_useringred', 'selected')

        # Adding field 'UserIngred.selected_item'
        db.add_column(u'topshelf_useringred', 'selected_item',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'UserIngred.selected'
        db.add_column(u'topshelf_useringred', 'selected',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Deleting field 'UserIngred.selected_item'
        db.delete_column(u'topshelf_useringred', 'selected_item')
    ...
    models = {
        ...
        u'topshelf.useringred': {
            ...
            'selected_item': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
