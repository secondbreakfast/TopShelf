...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'IngredMaster_test'
        db.create_table(u'topshelf_ingredmaster_test', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('ing', self.gf('django.db.models.fields.CharField')(max_length=100)),
        ))
        db.send_create_signal(u'topshelf', ['IngredMaster_test'])


    def backwards(self, orm):
        # Deleting model 'IngredMaster_test'
        db.delete_table(u'topshelf_ingredmaster_test')
